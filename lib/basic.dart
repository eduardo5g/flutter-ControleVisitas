...
const String _kGalleryAssetsPackage = 'grid_list_image_comment_assets';
...
class _RecipeGridPageState extends State<RecipeGridPage> {
    ...
    return Theme(
      ...
      child: Scaffold(
        ...
        body: CustomScrollView(
          ...
          slivers: <Widget>[
            _buildAppBar(context, 300), //statusBarHeight),
            _buildBody(context, 300), //statusBarHeight),
          ],
        ),
      ),
    );
  ...
  Widget _buildBody(BuildContext context, double statusBarHeight) {
    ...
    final EdgeInsets padding = EdgeInsets.only(
      top: 8.0,
      left: 8.0 + 0, //mediaPadding.left,
      right: 8.0 + 0, // mediaPadding.right,
      bottom: 8.0,
    );
...
class _RecipePageState extends State<RecipePage> {
  ...
  Widget build(BuildContext context) {
    ...
    final double appBarHeight = 1024;//_getAppBarHeight(context);
