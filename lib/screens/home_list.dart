        ...
        return Card(
          ...
          child: ListTile(
            leading: CircleAvatar(
              backgroundColor:
                  getPriorityColor(this.homeList[position].priority),
              child: getPriorityIcon(this.homeList[position].priority),
            ),
            title: Text(
              this.homeList[position].number,
              style: nameStyle,
            ),
              ...
              children: <Widget>[
                Padding(
                  ...
                  child: GestureDetector(
                    ...
                    onTap: () {
                      debugPrint(
                          "Edit casa: " + this.homeList[position].number);
                      navigateToDetail(this.homeList[position],
                          this.homeList[position].number);
                    },
                  ),
                ),
                Padding(
                  ...
                  child: GestureDetector(
                    ...
                    onTap: () {
                      debugPrint(
                          "Delete casa: " + this.homeList[position].number);
            ...
            onTap: () {
              debugPrint(
                  "Listing Citizens home: " + this.homeList[position].number);
